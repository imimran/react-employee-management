...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      { path: "/organizations", state: "organizationsMenuOpen" },
      { path: "/employee", state: "employeeMenuOpen" },
      { path: "/attendence", state: "attendenceMenuOpen" },
      { path: "/cost", state: "costMenuOpen" },
      { path: "/payroll", state: "payrollMenuOpen" },
      { path: "/announcement", state: "announcementMenuOpen" },
      { path: "/leave-request", state: "leaveRequestMenuOpen" },
    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li
            className={
              this.isPathActive("/organizations")
                ? "nav-item active"
                : "nav-item"
            }
          >
            <div
              className={
                this.state.organizationsMenuOpen
                  ? "nav-link menu-expanded"
                  : "nav-link"
              }
              onClick={() => this.toggleMenuState("organizationsMenuOpen")}
              data-toggle="collapse"
            >
              <i className="mdi mdi-lock-outline menu-icon"></i>
              <span className="menu-title">
            ...
            <Collapse in={this.state.organizationsMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={
                      this.isPathActive("/organizations/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
          ...
          <li
            className={
              this.isPathActive("/employee") ? "nav-item active" : "nav-item"
            }
          >
            <div
              className={
            ...
            <Collapse in={this.state.employeeMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/employee/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/employee/create"
          ...
          <li
            className={
              this.isPathActive("/attendence") ? "nav-item active" : "nav-item"
            }
          >
            <div
              className={
                this.state.attendenceMenuOpen
                  ? "nav-link menu-expanded"
                  : "nav-link"
              }
              onClick={() => this.toggleMenuState("attendenceMenuOpen")}
              data-toggle="collapse"
            >
              <i className="mdi mdi-lock-outline menu-icon"></i>
              <span className="menu-title">
            ...
            <Collapse in={this.state.attendenceMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={
                      this.isPathActive("/attendence/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/attendence/create"
                  >
                    <Trans>Create Attendence</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  {" "}
          ...
          <li
            className={
              this.isPathActive("/announcement")
                ? "nav-item active"
                : "nav-item"
            }
          >
            <div
              className={
                this.state.announcementMenuOpen
                  ? "nav-link menu-expanded"
                  : "nav-link"
              }
              onClick={() => this.toggleMenuState("announcementMenuOpen")}
              data-toggle="collapse"
            >
              <i className="mdi mdi-lock-outline menu-icon"></i>
              <span className="menu-title">
            ...
            <Collapse in={this.state.announcementMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={
                      this.isPathActive("/announcement/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
          ...
          <li
            className={
              this.isPathActive("/payroll") ? "nav-item active" : "nav-item"
            }
          >
            <div
              className={
                this.state.payrollMenuOpen
                  ? "nav-link menu-expanded"
                  : "nav-link"
              }
              onClick={() => this.toggleMenuState("payrollMenuOpen")}
              data-toggle="collapse"
            >
              <i className="mdi mdi-lock-outline menu-icon"></i>
              <span className="menu-title">
            ...
            <Collapse in={this.state.payrollMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={
                      this.isPathActive("/payroll/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/payroll/create"
                  >
                    <Trans>Create Payroll</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  {" "}
          ...
          <li
            className={
              this.isPathActive("/cost") ? "nav-item active" : "nav-item"
            }
          >
            <div
              className={
            ...
            <Collapse in={this.state.costMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/cost/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/cost/create"
                  >
                    <Trans>Create Cost Amount</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  {" "}
          ...
          <li
            className={
              this.isPathActive("/leave-request")
                ? "nav-item active"
                : "nav-item"
            }
          >
            <div
              className={
                this.state.leaveRequestMenuOpen
                  ? "nav-link menu-expanded"
                  : "nav-link"
              }
              onClick={() => this.toggleMenuState("leaveRequestMenuOpen")}
              data-toggle="collapse"
            >
              <i className="mdi mdi-lock-outline menu-icon"></i>
              <span className="menu-title">
            ...
            <Collapse in={this.state.leaveRequestMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={
                      this.isPathActive("/leave-request/create")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/leave-request/create"
                  >
                    <Trans>Create Leave Request </Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  {" "}
